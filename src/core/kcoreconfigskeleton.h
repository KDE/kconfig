...
public:
    ...
    /*!
     * Indicates if this item is set to its default value.
     * \since 5.64
     */
...
public:
    ...
    /*!
     * Sets a notify function, it will be invoked when the value of the property changes.
     * \since 5.68
     */
...
public:
    ...
    public:
        ...
        /*!
         * The list of enum \a choices that can be stored in this item.
         */
...
protected:
    ...
    /*!
     * Performs the actual writing of the configuration file.
     *
