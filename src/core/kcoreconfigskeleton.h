...
public:
    ...
    public:
        /*! */
        ItemTime(const QString &_group, const QString &_key, QTime &reference, const QTime &defaultValue = QTime());
...
public:
     ...
     * \since 6.16
     */
    ItemTime *addItemTime(const QString &name, QTime &reference, const QTime &defaultValue = QTime(), const QString &key = QString());
